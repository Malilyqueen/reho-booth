...
function initializeChat() {
    ...
    const aiResponses = {
        ...
        "immobilier": "Pour votre projet d'achat immobilier avec un budget de 250 000€, voici les étapes clés :\n1. Épargner pour l'apport (idéalement 10-20%, soit 25 000-50 000€)\n2. Vérifier votre capacité d'emprunt (environ 4.5 fois vos revenus annuels nets)\n3. Prévoir un budget additionnel pour les frais de notaire (~8-10% du prix d'achat)",
        "crédit": "Basé sur vos revenus et charges actuels, vous pourriez emprunter environ 180 000€ sur 25 ans. Avec le taux moyen actuel de 3.4%, cela représenterait une mensualité d'environ 890€/mois, soit 33% de vos revenus nets.",
        "retraite": "Pour préparer votre retraite, je vous recommande de commencer à épargner 10-15% de vos revenus mensuels dans un plan d'épargne retraite. À votre âge, avec un placement à 4% de rendement annuel moyen, cela pourrait vous constituer un capital d'environ 320 000€ d'ici 30 ans."
    };
